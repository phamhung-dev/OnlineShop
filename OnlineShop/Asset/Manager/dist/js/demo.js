...
/*  setTimeout(function () {
  ...
  $container.append('<h6>Đầu trang</h6>')
...
/*  var $dropdown_legacy_offset_checkbox = $('<input />', {
  ...
  $container.append('<h6>Cuối trang</h6>')
  ...
  $container.append('<h6>Chữ nhỏ</h6>')
  ...
  var $text_sm_body_container = $('<div />', { class: 'mb-1' }).append($text_sm_body_checkbox).append('<span>Toàn bộ</span>')
  ...
  var $text_sm_header_container = $('<div />', { class: 'mb-1' }).append($text_sm_header_checkbox).append('<span>Điều hướng trên</span>')
  ...
  var $text_sm_brand_container = $('<div />', { class: 'mb-1' }).append($text_sm_brand_checkbox).append('<span>Nhãn hiệu</span>')
  ...
  var $text_sm_sidebar_container = $('<div />', { class: 'mb-1' }).append($text_sm_sidebar_checkbox).append('<span>Điều hướng bên</span>')
  ...
  var $text_sm_footer_container = $('<div />', { class: 'mb-4' }).append($text_sm_footer_checkbox).append('<span>Cuối trang</span>')
...
/*  var accent_colors = [
  ...
  $container.append('<h6>Thanh điều hướng trên</h6>')

  var $navbar_variants = $('<div />', {
    class: 'd-flex'
  })
  var navbar_all_colors = navbar_dark_skins.concat(navbar_light_skins)
    // Use a temp variable to save pre-color, color replace bg- into navbar- because createSkinBlock function replaced navbar- into bg- 
    // so we can't use indexOf to find exist of color in array navbar_dark_skins
  var colorTemp = ''
  var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function () {
    var color = $(this).find('option:selected').attr('class')
    var $main_header = $('.main-header')
    colorTemp = colorTemp.replace('navbar-','bg-')
    $main_header.removeClass('navbar-dark').removeClass('navbar-light').removeClass(colorTemp)
    navbar_all_colors.forEach(function (color) {
    $main_header.removeClass(color)
    })
    $(this).removeClass().addClass('custom-select mb-3 text-light border-0 ')
    colorTemp = color.replace('bg-', 'navbar-')
    if (navbar_dark_skins.indexOf(colorTemp) > -1) {
...
/*  $container.append('<h6>Accent Color Variants</h6>')
  ...
  $container.append('<h6>Thanh bên tối</h6>')
  ...
  $container.append('<h6>Thanh bên sáng</h6>')
